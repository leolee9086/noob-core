...
export function  toggleModel(type, show = false, close = false) {
        ...
        if (target.classList.contains("dock__item--active")) {
            ...
            if (this.element.querySelectorAll(".dock__item--active").length === 0) {
                ...
                if (window.parent.document.querySelector("body").classList.contains("body--win32")) {
                    window.parent.document.getElementById("drag").classList.remove("fn__hidden");
                }
            ...
            if ((type === "graph" || type === "globalGraph") &&
                window.parent.document.querySelector("body").classList.contains("body--win32") && this.layout.element.querySelector(".fullscreen")) {
                window.parent.document.getElementById("drag").classList.add("fn__hidden");
            }
            if (this.pin) {
