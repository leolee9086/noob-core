...
declare class Wnd{
    ...
    public showHeading()
    public switchTab(target: HTMLElement, pushBack : boolean, update : boolean) 
    public addTab(tab: Tab, keepCursor : boolean)
    private renderTabList(event: MouseEvent)
    private removeOverCounter(oldFocusIndex?: number)
    private destroyModel(model: Model)
    private removeTabAction  (id: string, closeAll: boolean, hasSaveScroll : boolean, animate : boolean)
...
declare class  Editor extends Model {
    public element: HTMLElement;
